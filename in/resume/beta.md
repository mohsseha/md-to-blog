...
<p>
    ...
    **jsdlkdj** sdkldlsld __dalkjdajkadl__ adlkdakldaljkda *dsds* 
</p>
...
<p>
    <label for="mn-figure-1" class="margin-toggle">⊕</label><input type="checkbox" id="mn-figure-1" class="margin-toggle">
    <span class="marginnote">
    - **Team Scale:** varied at irobot from 4-12 (including contractors and interns), current position 8 (50% PhD's)
    - **Growth:** centeralized all ML into one org. Recurited my boss (DDean), actively asked my team to be reduced to improve focus. The ML team now is 25+ members.
</p>

- **ML Research & Development** of embedded robot Deep Learning models that:  
	- run embedded using TensorFlow Lite with <1% error in *millions* of homes. 
	- are _reproducibly_ trained using Docker and KubeFlow Pipelines. The modular pipelines support both *research* & *production* workflows.  
	- use the latest training techniques including Population Based Training, Active Learning and Semi-supervised pre-training. 


<p>
    <label for="mn-figure-1" class="margin-toggle">⊕</label><input type="checkbox" id="mn-figure-1" class="margin-toggle">
    <span class="marginnote">
    - **fresh** we were never more than 6 months away from the SOTA for our applications. 
    - emphasize **simple practical solutions**, eg. start with GIT LFS.
</p>

- **Scalable Data collection processes and infrastructure** with: 
	- ~10^8 labeled and unlabeled images.
	- user privacy guarantees exceeding GDPR requirements.
...
<p>
    <label for="mn-figure-1" class="margin-toggle">⊕</label><input type="checkbox" id="mn-figure-1" class="margin-toggle">
    <span class="marginnote">
    - responsible for almost all ML Vision patents in the last couple of years.
    - help direct iRobot investments and partnerships in 
        1. _Synthetic Data_ 
        2. _Augmented Reality_  (including minor effort with Apple)
        3. long-erm partnership with Google Cloud AI (eg. NAS, PBT, AutoML, explainability, TensorFlow Lite steering team)
</p>
